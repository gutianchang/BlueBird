...
#define MPU_RAW_DATA_LEN		14


unsigned char MPU_Init(void); 								//初始化MPU6050
unsigned char MPU_Write_Len(unsigned char addr,unsigned char reg,int len,unsigned char *buf);//IIC连续写
unsigned char MPU_Read_Len(unsigned char addr,unsigned char reg,int len,unsigned char *buf); //IIC连续读
